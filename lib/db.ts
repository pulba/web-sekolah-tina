...
console.log('Token available:', !!import.meta.env.TURSO_AUTH_TOKEN);
...
export async function insertUser(userData: UserData) {
  try {
    console.log('Inserting user with data fields:', Object.keys(userData));
    ...
    console.log('Prepared data for insert: userId =', userId);
